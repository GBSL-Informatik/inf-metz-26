...
## Die Unicode-Tabelle
Das Ergebnis der Arbeit des Unicode-Consortiums ist die [Unicode-Tabelle](https://en.wikipedia.org/wiki/List_of_Unicode_characters), die stetig erweitert wird. In Ihrer Version 16.0 umfasst die Tabelle bereits 155'063 Zeichen[^1].
...
Suchen Sie in der [Unicode-Tabelle](https://en.wikipedia.org/wiki/List_of_Unicode_characters) nach den folgenden Codepoints und kopieren Sie das jeweilige Zeichen in das dazugehörige Antwortfeld.
