...
**SVG** ist eine sogenannte _Auszeichnungssprache_ (also eine formale Sprache), mit der man Vektorgrafiken definieren kann.
...
In dieser Aufgabe lernen Sie einige weitere SVG Befehle kennen, die Sie in SVG Grafiken verwenden können. In der nächsten Aufgabe werden Sie damit anschliessend eine eigene Vektorgrafik entwerfen.

Kopieren Sie die folgenden SVG-Beispiele auf die [SVG Viewer Seite](https://www.rapidtables.com/web/tools/svg-viewer-editor.html) und analysieren Sie, was die neuen Befehle und die Ergänzungen der bereits bekannten Befehle bewirken.
