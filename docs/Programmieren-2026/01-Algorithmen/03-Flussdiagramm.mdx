...
Mit diesen Elementen können wir beispielsweise den Algorithmus für das Kochen von Spaghetti wie folgt ausdrücken:
...
Flussdiagramme haben kein spezifisches Symbol für Schleifen. Mann kann sie aber dennoch darstellen.
