...
<DefinitionList>
  ...
  <dt>Format</dt>
  <dd>Theoriefragen auf Papier</dd> 
  
  <dt>Hilfsmittel</dt>
  <dd>
    - Taschenrechner
    - keine anderen Hilfsmittel
  </dd>
...
:::info[Prüfungsstoff]
- Sie können für einen gegebenen Sachverhalt entscheiden, ob es sich dabei um einen Algorithmus handelt oder nicht und dies begründen.
