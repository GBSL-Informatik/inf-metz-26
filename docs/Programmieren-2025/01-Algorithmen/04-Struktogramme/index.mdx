...
:::tip[Bemerke]
Beim Struktogramm wird der wiederholte Teil durch die **Einrückung** ersichtlich. Auch beim Programmieren mit vielen Programmiersprachen werden wiederholte Sequenzen visuell mit einem Tabulator eingerückt.
:::
...
Dieser Block erlaubt uns, den Wert einer Variablen – in diesem Fall `x` – von aussen vorzugeben. Eine solche Variable nennem wir einen **Parameter**. _Parameter_ sind die **E**ingabe im **EVA**-Prinzip. Wir können damit steuern, mit welchem Wert (oder welchen Werten) der Algorithmus ausgeführt werden soll.
